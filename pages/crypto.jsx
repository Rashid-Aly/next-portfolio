      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <a
            ...
            rel='noreferrer'
          >
            <button className='px-8 py-2 mt-4 mr-8 shadow-sm'>Code</button>
          </a>
          <a
            ...
            rel='noreferrer'
          >
            <button className='px-8 py-2 mt-4 shadow-sm'>Demo</button>
          </a>

        </div>
        <div className='col-span-4 md:col-span-1 flex justify-center shadow-sm shadow-gray-400 rounded-md py-4'>
          <div className='p-2'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1 '>
              ...
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-2' /> Coin Gecko API
              </p>
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-2' /> Routes
              </p>
            </div>
          </div>
        </div>
